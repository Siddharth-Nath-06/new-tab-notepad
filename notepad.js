...
parentproto.innerHTML =
    ...
    <div class="titlebar"
        style="display: flex; flex-direction: row; align-items: center; width: 100%; height:2em; align-content: center; background-color: black; color: white; font-family:monospace; font-size: 1.2em; font-weight: bold; user-select:none; cursor: all-scroll;">
        <span
        ...
        <div class="title" contenteditable="" spellcheck="false" style="margin: 0em 0.5em; max-width: 23em; padding: 0em 0.5em; cursor: text;">Notepad</div>
...
parentmin.innerHTML =
    ...
    <div class="titlebar" style="cursor:all-scroll; font-weight:bold; height:2em; display:flex; align-items: center; user-select:none;">
        ...
        <div class="maximize" style="margin:0.25em 0.5em 0em auto; cursor: pointer;">
